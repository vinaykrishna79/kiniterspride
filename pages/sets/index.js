...
class Knitting_Crochet_Sets extends Component {
    state = {
        templateData: [],
        language: "",
        seoTitle: "",
...
// export default withRouter(withTranslation()(Knitting_Crochet_Sets));
...
export default withRouter(Knitting_Crochet_Sets)
